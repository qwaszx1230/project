	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'14px',height:'14px',borderRadius:'50%',lineHeight:'14px',right:'50%',bottom:'50px',fontSize:'10px',background:"#fff",color:"#fff",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left',verticalAlign:'bottom'},
								//当前 按钮样式
								focus:{background:"#d4b07b",border:"2px solid #fff",color:"#fff",width:'18px',height:'18px',borderRadius:'50%',}
							},
